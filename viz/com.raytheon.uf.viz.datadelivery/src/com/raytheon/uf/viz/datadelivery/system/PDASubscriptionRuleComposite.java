...
/**
 * PDA subscription overlap rules composite.
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
...
public class PDASubscriptionRuleComposite extends SubscriptionComposite {
    /** Time spinner */
     ...
     *            Parent Composite
     */
    public PDASubscriptionRuleComposite(Composite parent) {
        super(parent, DataType.PDA);
    }
    ...
    protected final void loadConfiguration() {
        ...
        PDASubscriptionOverlapConfig config = (PDASubscriptionOverlapConfig) ruleManager
