 ...
 * Aug 20, 2012  743      djohnson  Set group name on construction.
 * Sep 14, 2012  1169     djohnson  Use registry object configuration from
 *                                  {@link Subscription}.
 * Sep 21, 2012  1169     djohnson  Add @RegistryObject again, shouldn't show up
 ...
 * Oct 02, 2013  1797     dhladky   Generics start
 * Oct 11, 2013  2460     dhladky   Restored Adhoc's to registryObject store,
 *                                  WFO only
 * Oct 23, 2013  2484     dhladky   Unique ID for subscriptions updated.
 * Nov 14, 2013  2548     mpduff    Add a subscription type slot.
 * Jan 23, 2013  2584     dhladky   Versions.
 * Jul 28, 2014  2752     dhladky   Recurring constructor for Adhocs so that
...
public class AdhocSubscription<T extends Time, C extends Coverage>
        extends SiteSubscription<T, C> {

    private static final long serialVersionUID = -2200080380095632486L;

    /**
     * Url for the DataSetMetaData this Adhoc is for.
     */
    @XmlAttribute
