 ...
 * @author djohnson
 */
public interface ISubscriptionTypeHandler<T extends Subscription>
     ...
     */
    T getByPendingSubscription(PendingSubscription pending)
            throws RegistryHandlerException;
     ...
     * @throws RegistryHandlerException
     */
    T getByPendingSubscriptionId(String id) throws RegistryHandlerException;
    ...
    /**
     * Retrieve subscriptions for the dataset name and provider.
     *
     * @param dataSetName
     *            the dataset name
     * @param providerName
     *            the provider name
     */
    List<T> getByDataSetAndProvider(String dataSetName, String providerName)
            throws RegistryHandlerException;
}
