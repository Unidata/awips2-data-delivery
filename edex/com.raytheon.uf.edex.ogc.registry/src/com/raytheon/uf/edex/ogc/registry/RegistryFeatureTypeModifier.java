...
public class RegistryFeatureTypeModifier implements IFeatureTypeModifier {
    ...
    public OgcGeoBoundingBox getBoundingBox(String name) {
        ...
        try {
            /*
             * We default to whole earth now. We don't really care about the
             * DataSet specific areas for the feature. They are added together
             * and treated as a whole for requests from the DPA
             */
