 ...
 * @version 1.0
 */
public class DataSetMetaDataDao extends
    ...
    private static String GET_IDS_BEYOND_RETENTION = "SELECT o.id FROM RegistryObjectType o inner join o.slot s1 inner join s1.slotValue v1 inner join o.slot s2 inner join s2.slotValue v2 "
            + "WHERE o.objectType=:objectType and s1.name = :providerSlotName and v1.stringValue = :provider and s2.name = :dateSlotName and v2.integerValue < :retentionTime order by v2.integerValue";
