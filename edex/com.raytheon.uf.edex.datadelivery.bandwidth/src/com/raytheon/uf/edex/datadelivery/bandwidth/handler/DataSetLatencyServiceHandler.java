...
public class DataSetLatencyServiceHandler
        extends AbstractPrivilegedRequestHandler<DataSetLatencyRequest> {
     ...
     */
    @Override
    public AuthorizationResponse authorized(DataSetLatencyRequest request)
