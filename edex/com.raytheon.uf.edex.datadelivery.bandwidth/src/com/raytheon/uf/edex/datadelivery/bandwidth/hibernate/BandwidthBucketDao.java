 ...
 * Feb 11, 2013  2636     mpduff    Changed
 *                                  GET_WHERE_START_TIME_IS_BETWEEN_INCLUSIVE
 *                                  query.
 ...
 * @author djohnson
 */
public class BandwidthBucketDao extends SessionManagedDao<Long, BandwidthBucket>
        implements IBandwidthBucketDao {

    private static final String DELETE_UP_TO_TIME = "delete from BandwidthBucket bb where bb.network = :network and bb.bucketStartTime < :bucketStartTime 0";
    ...
    public void deleteBucketsUpToTime(long timeToDeleteUpTo, Network network)
        ...
        executeHQLStatement(DELETE_UP_TO_TIME, "network", network,
                "bucketStartTime", timeToDeleteUpTo);
    }
    ...
    public SortedSet<BandwidthBucket> getBucketsInWindow(Long startMillis,
        ...
        return Sets.<BandwidthBucket> newTreeSet(
                this.<BandwidthBucket> executeHQLQuery(
