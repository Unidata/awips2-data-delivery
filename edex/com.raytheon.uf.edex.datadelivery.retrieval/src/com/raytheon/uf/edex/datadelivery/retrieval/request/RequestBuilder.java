 ...
 * Jul 31, 2017  6186     rjpeter   Use Retrieval
 *
 * </pre>
 *
 * @author dhladky
 */
public abstract class RequestBuilder<T extends Time, C extends Coverage>
        implements IRetrievalRequestBuilder<T, C> {
    ...
    protected final Retrieval<T, C> retrieval;

    protected RequestBuilder(Retrieval<T, C> retrieval) {
     ...
     * @return
     */
    public Retrieval<T, C> getRetrieval() {
        return retrieval;
    }
}
