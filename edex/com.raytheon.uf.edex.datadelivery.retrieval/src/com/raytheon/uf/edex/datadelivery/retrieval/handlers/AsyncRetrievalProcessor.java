...
public class AsyncRetrievalProcessor {
     ...
     * @param retrievalDao
     */
    public AsyncRetrievalProcessor(String destinationUri, IRetrievalDao retrievalDao) {
    ...
    public void processRetrieval(byte[] retrievalBytes) {
        ...
        try {
            ...
            statusHandler.error(
                    "Couldn't deserialize RetrievalResponse class! ", e);
        }

        if (ars != null) {

            RetrievalRequestRecordPK pk = new RetrievalRequestRecordPK(
                    ars.getSubscriptionName(), ars.getRetrievalID());
            /**
            ...
            try {
                 ...
                 */
                    ...
                    statusHandler
                            .debug("Async retrieval arrived too soon, waiting. "
                                    + ars.getRetrievalID());
                    isRemove = false;
                }
                ...
                statusHandler.handle(
                        Priority.PROBLEM,
                        "Couldn't process AsyncRetrievalResponse! ID: "
                                + pk.toString(), e);
            } finally {
