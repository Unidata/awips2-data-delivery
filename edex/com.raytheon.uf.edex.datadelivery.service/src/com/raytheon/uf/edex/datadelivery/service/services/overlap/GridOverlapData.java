 ...
 *                                  compared against, and changed the spatial
 *                                  check to check the intersection coverage of
 *                                  sub, not otherSub.
 * Nov 12, 2015  4622     dhladky   Added Level checks for Grids.
 * Mar 09, 2016  4644     tjensen   Fix comparison of overlapping levels
 * Sep 12, 2017  6413     tjensen   Removed levelDuplication. Combined with
 *                                  parameterDuplication from OverlapData.
 *
 * </pre>
 *
 * @author mpduff
...
public class GridOverlapData<T extends GriddedTime, C extends GriddedCoverage>
    ...
    private static final int numberOfGridAttributes = 2;
    ...
    protected void determineOverlapping() {
        ...
        fcstHrPass = fcstHrDuplication >= gconfig
                .getMaxAllowedForecastHourDuplication();

        cyclePass = cycleDuplication >= gconfig.getMaxAllowedCycleDuplication();
    }
