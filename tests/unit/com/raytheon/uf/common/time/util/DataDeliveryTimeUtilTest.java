 ...
 *    DataDeliveryTimeUtilTest.freezeTime();
 ...
 * @version 1.0
 */
public class DataDeliveryTimeUtilTest {
     ...
     * <pre>
     * {@code 
     * DataDeliveryTimeUtilTest.installMockTimes(new long[] 10L, 20L, 30L}); 
     ...
     * <pre>
     * {@code 
     * DataDeliveryTimeUtilTest.installMockTimes(5, TimeUnit.MINUTES); 
    ...
    public static void installMockTimes(long amount, TimeUnit unit) {
        ...
        DataDeliveryTimeUtilTest.installMockTimes(new long[] { start, end });
    }
     ...
     * <pre>
     * {@code 
     * DataDeliveryTimeUtilTest.freezeTime(15151515L); 
    ...
    public void testFreezeTimeAtSpecificTimeUsesTheParameter() {
        ...
        DataDeliveryTimeUtilTest.freezeTime(timeToFreezeAt);
    ...
    public void testInstallMockTimesWithTimeUnitSetsUpCorrectTime() {
        ...
        DataDeliveryTimeUtilTest.installMockTimes(2, TimeUnit.HOURS);
    ...
    public void testGetPriorityEnabledClockReturnsClockImplWhenPriorityEnabled() {
        IUFStatusHandler handler = UFStatus.getHandler(DataDeliveryTimeUtilTest.class);
        ITimer clock = TimeUtil.getPriorityEnabledTimer(handler,
                Priority.CRITICAL);
